					...
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="row entry-meta">
								...
								<?php
									...
									printf( __( '<div class="col-md-12">Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a></div>', 'upbootwp' ),
									...
									//edit_post_link( __( 'Edit', 'upbootwp' ), '<div class="col-md-6"><span class="edit-link">', '</span></div>' );
								?>
						</div>
						<div class="row">
							<nav role="navigation" id="image-navigation" class="col-md-12 image-navigation">
								<div class="nav-previous col-md-6"><?php previous_image_link( false, __( '<span class="meta-nav">&larr;</span> Previous', 'upbootwp' ) ); ?></div>
								<div class="nav-next col-md-6"><?php next_image_link( false, __( 'Next <span class="meta-nav">&rarr;</span>', 'upbootwp' ) ); ?></div>
