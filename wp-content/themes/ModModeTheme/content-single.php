	...
	<footer class="entry-meta">
		<?php
			...
			if ( ! upbootwp_categorized_blog() ) {
				...
				if ( '' != $tag_list ) {
					$meta_text = __( '<p>This entry was tagged %2$s.</p> <p>Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.</p>', 'upbootwp' );
				} else {
		...
		<?php edit_post_link( __( 'Edit', 'upbootwp' ), '<p><span class="edit-link">', '</span></p>' ); ?>
	</footer><!-- .entry-meta -->
</article><!-- #post-## -->
