<?php
/**
 * Template Name: Dealer Locator Page - Full Width
...
<?php while (have_posts()) : the_post(); ?>
	...
	<div id="mrktg-content" class="container">
		...
		<div class="entry-content marketing row">
			<div class="col-md-12">
			<?php the_content(); ?>
		...
		<div class="row">
			...
			<iframe id="EasyLocator" width="280" height="450" scrolling="no" frameborder="0" src="//www.easylocator.net/search/mobile/Mode 2.0 Mobile" allowtransparency="true"></iframe>
			<!-- End Easy Locator Store Locator Service //-->
			</div>

			<div class="hidden-xs hidden-sm col-md-12">
<!-- Begin Easy Locator Store Locator Service //-->
<iframe id="EasyLocator" width="900" height="800" scrolling="no" frameborder="0" src="//www.easylocator.net/search/map3/Mode 2.0 Desktop/template/template3_2" allowtransparency="true"></iframe>
<!-- End Easy Locator Store Locator Service //-->
			</div>
		</div>
